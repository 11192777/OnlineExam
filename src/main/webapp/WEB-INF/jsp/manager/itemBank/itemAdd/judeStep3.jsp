...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form role="form" style="margin-top:20px;">
					...
					<hr>
					<button type="button" onclick="window.location.href='${APP_PATH}/manager/itemBank/itemAdd/judeStep2'" class="btn btn-default">上一步</button>
	...
	<script type="text/javascript">
		...
		var registerInfo2 = JSON.parse(sessionStorage.getItem('step2_info_2'));
		$(function() {
			...
			if (registerInfo2.topicResult == "true") {
				topicViewContext += '<label style="font-size: 24px; font-family: \'楷体\';" for="exampleInputEmail1" >#.' + registerInfo2.topicContent + '   （' + '√' + '）</label><br>';
			} else {
				topicViewContext += '<label style="font-size: 24px; font-family: \'楷体\';" for="exampleInputEmail1" >#.' + registerInfo2.topicContent + '   （' + '×' + '）</label><br>';
			}
		...
		$("#completeButton").click(function() {
			...
			jsonData.result = registerInfo2.topicResult;
			$.ajax({
				type : "POST",
				url : "${APP_PATH}/manager/itemBank/itemAdd/doAddJudeItem",
				data : jsonData,
				beforeSend : function() {
					index = layer.load(2, {
						time : 10 * 1000
				...
				success : function(result) {
					...
					if (result.success) {
						layer.msg("添加成功", {
							...
							window.sessionStorage.removeItem('step2_info_2');
